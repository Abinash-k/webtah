          ...
          <ScrollReveal>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <ServiceBox 
                ...
                icon={<Code />}
                color="blue"
                description="Tailored websites designed to meet your specific business requirements and brand identity."
              ...
              <ServiceBox 
                ...
                imageSrc="https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400"
              />
              ...
              <ServiceBox 
                ...
                icon={<Settings />}
                color="blue"
                description="Complex web applications with advanced features and functionality."
                imageSrc="https://images.unsplash.com/photo-1461749280684-dccba630e2f6?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400"
              />
            </div>
          </ScrollReveal>
        </div>
          ...
          <ScrollReveal>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                />
                <img 
                  src="https://images.unsplash.com/photo-1581093450021-4a7360e9a6b5?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400" 
                  alt="Development" 
                  className="rounded-lg shadow-md object-cover h-48 transform hover:scale-105 transition-transform duration-500"
                />
                <img 
                  src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400" 
                  alt="Code" 
                  className="rounded-lg shadow-md object-cover h-48 transform hover:scale-105 transition-transform duration-500"
                />
              </div>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container-custom">
          <ScrollReveal>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <TestimonialCard 
                quote="Webtah Technologies delivered a stunning website that perfectly represents our brand. Their development team was responsive and professional throughout the entire process." 
              ...
              <TestimonialCard 
                quote="Their team built our e-commerce platform from the ground up. The attention to detail and focus on user experience resulted in higher conversion rates and increased sales." 
              ...
              <TestimonialCard 
                quote="Webtah developed a complex web application for our business that streamlined our operations. Their technical expertise and commitment to quality are unmatched." 
