          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:flex justify-end">
              <div className="relative">
                ...
                <img alt="Digital solutions concept" className="rounded-lg shadow-2xl border border-blue-800/30 w-full max-w-md object-cover transform hover:scale-105 transition-transform duration-500" src="https://www.theforage.com/blog/wp-content/uploads/2022/12/what-is-cybersecurity-1024x631.jpg" />
              </div>
            </div>
          </div>
        </div>
          ...
          <ScrollReveal>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                ...
                <img src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400" alt="Web development" className="rounded-lg shadow-lg object-cover w-full transform hover:scale-105 transition-transform duration-500" />
              </div>
            </div>
          </ScrollReveal>
        </div>
          ...
          <ScrollReveal>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 relative">
                ...
                <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400" alt="Digital marketing" className="rounded-lg shadow-lg object-cover w-full transform hover:scale-105 transition-transform duration-500" />
              </div>
        ...
        <div className="container-custom">
          <ScrollReveal>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="absolute -z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-blue-400 opacity-10 rounded-full"></div>
                <img src="https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400" alt="Cybersecurity" className="rounded-lg shadow-lg object-cover w-full transform hover:scale-105 transition-transform duration-500" />
              </div>
            </div>
          </ScrollReveal>
        </div>
        ...
        <div className="container-custom">
          <ScrollReveal>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <TestimonialCard quote="Webtah delivered an exceptional website that perfectly represents our brand. Their attention to detail and responsiveness made the process smooth from start to finish." author="Sarah Johnson" role="Marketing Director" rating={5} delay={100} image="https://images.unsplash.com/photo-1573497019236-61e7a3e1f341?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&h=150" />
              
              <TestimonialCard quote="Their digital marketing team transformed our online presence. Their data-driven approach increased our organic traffic by 200% in just six months." author="Michael Reynolds" role="CEO, TechCorp" rating={5} delay={200} image="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&h=150" />
              
              <TestimonialCard quote="We sleep better at night knowing Webtah is protecting our systems. Their cybersecurity team detected and neutralized a threat before any damage occurred." author="Jessica Brown" role="IT Director" rating={5} delay={300} image="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&h=150" />
            </div>
          </ScrollReveal>
        </div>
      </section>
          ...
          <ScrollReveal>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="hidden lg:block relative">
                ...
                <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400" alt="Team working together" className="rounded-lg shadow-2xl border border-blue-700/30 object-cover w-full transform hover:scale-105 transition-transform duration-500" />
              </div>
            </div>
          </ScrollReveal>
        </div>
